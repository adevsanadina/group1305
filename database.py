...
with sqlite3.connect(DB_PATH) as connection:
   ...
   # """
    ...
    query = """
        SELECT students.surname, students.name, students.specialization, students.school_number, schools.address, schools.floors
        FROM students
        LEFT JOIN schools ON students.school_number = schools.school_number
    """
    cursor.execute(query)
    students_with_schools = cursor.fetchall()
    pprint(students_with_schools)
